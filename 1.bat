...
"C:\PDFSCRIPT\SumatraPDF.exe" "C:\PDF\%test%1.pdf" -print-to "Front"
"C:\PDFSCRIPT\SumatraPDF.exe" "C:\PDF\%test%2.pdf" -print-to "Front"
"C:\PDFSCRIPT\SumatraPDF.exe" "C:\PDF\%test%3.pdf" -print-to "Front"
